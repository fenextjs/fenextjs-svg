...
exports.EyeBar = exports.Eye = void 0;
const tslib_1 = require("tslib");
const react_1 = tslib_1.__importDefault(require("react"));
const Eye = ({ className = '' }) => (react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 576 512", className: `fenext_svg ${className}` },
...
exports.Eye = Eye;
const EyeBar = ({ className = '' }) => (react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 512", className: `fenext_svg ${className}` },
