...
const Pinterest = ({ className = '' }) => (react_1.default.createElement("svg", { className: `fenext_svg ${className}`, viewBox: "0 0 650 650", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
