...
const Clicks = ({ className = '' }) => (react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 23.779 32.6", className: `fenext_svg ${className}` },
...
exports.default = exports.Clicks;
