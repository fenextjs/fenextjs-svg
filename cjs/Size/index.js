...
const Size = ({ className = '' }) => (react_1.default.createElement("svg", { className: `fenext_svg ${className}`, viewBox: "0 0 662 662", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
