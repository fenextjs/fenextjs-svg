...
exports.CopyBox = exports.Copy = void 0;
const tslib_1 = require("tslib");
const react_1 = tslib_1.__importDefault(require("react"));
const Copy = ({ className = '' }) => (react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: `fenext_svg ${className}`, viewBox: "0 0 23.469 29.309" },
...
exports.Copy = Copy;
const CopyBox = ({ className = '' }) => (react_1.default.createElement("svg", { className: `fenext_svg ${className}`, viewBox: "0 0 624 624", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
    react_1.default.createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M100 0C44.7715 0 0 44.7715 0 100V524C0 579.228 44.7715 624 100 624H524C579.228 624 624 579.229 624 524V100C624 44.7715 579.229 0 524 0H100ZM280 392H472C480.8 392 488 384.8 488 376V171.9L420.1 104H280C271.2 104 264 111.2 264 120V376C264 384.8 271.2 392 280 392ZM472 440H280C244.7 440 216 411.3 216 376V120C216 84.7 244.7 56 280 56H420.2C432.9 56 445.1 61.1 454.1 70.1L521.9 138C530.9 147 536 159.2 536 171.9V376C536 411.3 507.3 440 472 440ZM88 248C88 212.7 116.7 184 152 184H184V232H152C143.2 232 136 239.2 136 248V504C136 512.8 143.2 520 152 520H344C352.8 520 360 512.8 360 504V472H408V504C408 539.3 379.3 568 344 568H152C116.7 568 88 539.3 88 504V248Z", fill: "currentColor" })));
exports.CopyBox = CopyBox;
