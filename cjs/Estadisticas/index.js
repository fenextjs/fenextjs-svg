...
const Estadisticas = ({ className = '' }) => (react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: `fenext_svg ${className}`, viewBox: "0 0 31.47 31.517" },
...
exports.default = exports.Estadisticas;
