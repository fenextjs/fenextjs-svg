...
exports.PaginationDown = exports.PaginationNext = exports.PaginationPre = exports.PaginationUp = void 0;
const tslib_1 = require("tslib");
const react_1 = tslib_1.__importDefault(require("react"));
const PaginationUp = ({ className = '' }) => (react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", className: `fenext_svg ${className}` },
...
exports.PaginationUp = PaginationUp;
const PaginationPre = ({ className = '' }) => (react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 320 512", className: `fenext_svg ${className}` },
...
exports.PaginationPre = PaginationPre;
const PaginationNext = ({ className = '' }) => (react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 320 512", className: `fenext_svg ${className}` },
...
const PaginationDown = ({ className = '' }) => (react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", className: `fenext_svg ${className}` },
...
exports.PaginationDown = PaginationDown;
