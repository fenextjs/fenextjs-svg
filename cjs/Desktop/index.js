...
exports.DesktopLayer = exports.Desktop = void 0;
const tslib_1 = require("tslib");
const react_1 = tslib_1.__importDefault(require("react"));
const Desktop = ({ className = '' }) => (react_1.default.createElement("svg", { className: `fenext_svg ${className}`, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 576 512" },
...
const DesktopLayer = ({ className = '' }) => (react_1.default.createElement("svg", { className: `fenext_svg ${className}`, viewBox: "0 0 576 512", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
exports.DesktopLayer = DesktopLayer;
