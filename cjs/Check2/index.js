...
const Check2 = ({ className = '' }) => (react_1.default.createElement("svg", { className: `fenext_svg ${className}`, viewBox: "0 0 16 16", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
exports.default = exports.Check2;
